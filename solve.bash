...
INPUT="data/sys1.lin"
LOG="data/logs"
OUTPUT_NAIVE_SINGLE="data/sys1_naive_single.sol"
OUTPUT_SPP_SINGLE="data/sys1_spp_single.sol"
OUTPUT_NAIVE_DOUBLE="data/sys1_naive_double.sol"
OUTPUT_SPP_DOUBLE="data/sys1_spp_double.sol"
